...
int init_json_structure_module_main(cJSON *json) {
    ...
    while (json != NULL) {
        if (strcmp(json->string, "id") == 0) {
            ...
            json_config.modules.main_module.name = (char*)malloc(strlen(json->valuestring));
            memcpy(json_config.modules.main_module.name, json->valuestring, strlen(json->valuestring));
        } else {
...
int init_json_structure_module_camera(cJSON *json) {
    ...
    while (json != NULL) {
        if (strcmp(json->string, "id") == 0) {
            ...
            json_config.modules.camera_module.name = (char*)malloc(strlen(json->valuestring));
            memcpy(json_config.modules.camera_module.name, json->valuestring, strlen(json->valuestring));
...
int init_json_structure_module_camera_transmitter(cJSON *json) {
    ...
    while (json != NULL) {
        if (strcmp(json->string, "id") == 0) {
            ...
            json_config.modules.camera_transmitter_module.name = (char*)malloc(strlen(json->valuestring));
            memcpy(json_config.modules.camera_transmitter_module.name, json->valuestring, strlen(json->valuestring));
        } else if (strcmp(json->string, "state") == 0) {
...
int init_json_structure_module_gyroscope_receiver(cJSON *json) {
    ...
    while (json != NULL) {
        if (strcmp(json->string, "id") == 0) {
            ...
            json_config.modules.gyroscope_receiver_module.name = (char*)malloc(strlen(json->valuestring));
            memcpy(json_config.modules.gyroscope_receiver_module.name, json->valuestring, strlen(json->valuestring));
        } else if (strcmp(json->string, "state") == 0) {
...
int init_json_structure_module_motor(cJSON *json) {
    ...
    while (json != NULL) {
        if (strcmp(json->string, "id") == 0) {
            ...
            json_config.modules.motor_module.name = (char*)malloc(strlen(json->valuestring));
            memcpy(json_config.modules.motor_module.name, json->valuestring, strlen(json->valuestring));
        } else if (strcmp(json->string, "state") == 0) {
...
int init_json_structure_module_remote_controller(cJSON *json) {
    ...
    while (json != NULL) {
        if (strcmp(json->string, "id") == 0) {
            ...
            json_config.modules.remote_controller_module.name = (char*)malloc(strlen(json->valuestring));
            memcpy(json_config.modules.remote_controller_module.name, json->valuestring, strlen(json->valuestring));
        } else {
            print(ERROR, "cant parse argument %s", json->string);
            return -1;
        }
