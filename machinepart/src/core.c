...
static void* remote_controller_thread(void *user_data) {
    register_log_module(json_config.modules.remote_controller_module.name, pthread_self());
...
static void *camera_transmitter_thread(void *user_data) {
    register_log_module(json_config.modules.camera_transmitter_module.name, pthread_self());
...
static void *gyroscope_receiver_thread(void *user_data) {
    register_log_module(json_config.modules.gyroscope_receiver_module.name, pthread_self());
